...
export default function Main() {
  return (
    <div className="h-screen w-full rounded-md bg-neutral-950 relative flex flex-col items-center justify-center antialiased mt-[-50px]">
      <div className="max-w-2xl mx-auto p-4">
        ...
        <div className="flex justify-center items-center gap-6 my-6 z-10">
